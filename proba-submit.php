...
<div class="jumbotron">
  ...
  <ul class="list-group">
     <?php 
     if( provera( "tunisia_02", "burundi_03" ) ) { 
        ?>
      <li class="list-group-item d-flex li-match" >
       <div class="col-6 d-flex justify-content-end pr-2">
         <div>
       ...
       <div class="col-6 d-flex justify-content-start p-0">
         <div>
           <input class="match-2" type="number" name="burundi" id="burundi" value="<?php echo $burundi_03; ?>" disabled>
           <label class="label-2" for="burundi"  id ="home"><img src="images/burundi.png">Burundi</label>
         </div>
  ...
  <ul class="list-group">
     <?php 
     if( provera( "benin_02", "guinea-bissau_02" ) ) { 
        ?>
      <li class="list-group-item d-flex li-match" >
       <div class="col-6 d-flex justify-content-end pr-2">
         <div>
  ...
  <ul class="list-group">
     ...
     if( provera( "zimbabwe_03", "congo_03" ) ) { 
      ...
      <li class="list-group-item d-flex li-match" >
       ...
       <div class="col-6 d-flex justify-content-start p-0">
         <div>
           <input class="match-2" type="number" name="congo" id="congo" value="<?php echo $congo; ?>" disabled>
...
<ul class="list-group">
  ...
  <ul class="list-group">
     <?php 
     if( provera( "south-africa_03", "morocco_03" ) ) { 
        ?>
      <li class="list-group-item d-flex li-match" >
       <div class="col-6 d-flex justify-content-end pr-2">
         <div>
  ...
  <ul class="list-group">
     <?php 
     if( provera( "guinea-bissau_03", "ghana_03" ) ) { 
        ?>
      <li class="list-group-item d-flex li-match" >
       <div class="col-6 d-flex justify-content-end pr-2">
         <div>
  ...
  <input type="submit" value="Submit">   <a href="http://localhost/fudbal/contact.php">Email Form</a>
</form>
